...
**Download: [Chrome Web Store](https://chrome.google.com/webstore/detail/keyaffinity/jijefnemlojbcmplfaiklanbbcpeacaa?hl=en-US)** (v1.4) | **[Firefox](https://addons.mozilla.org/en-US/firefox/addon/keyaffinity/)** (v1.3.1d)
