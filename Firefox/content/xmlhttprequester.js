function keyaffinity_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
keyaffinity_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				keyaffinity_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
keyaffinity_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
keyaffinity_xmlhttpRequester.prototype.setupRequestEvent =
